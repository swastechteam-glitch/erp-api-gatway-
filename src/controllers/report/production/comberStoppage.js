// Comber Stoppage Wise report.
// Mirrors rptComber_Prodn_Stoppage.rdlc — one row per stoppage reason, with
// HRS and % columns for each shift, plus on-date and upto-date totals.
//
// SP: sp_Prodn_Comber_Stoppage (CompanyCode, FromDate, ToDate)
...
const TITLE = 'COMBER STOPPAGE REPORT';
const FILE_NAME = 'ComberProduction_StoppageWise';
...
export const comberStoppageReport = (req, res) => {
  return runReport(req, res, {
    spName: 'sp_Prodn_Comber_Stoppage',
    fileName: FILE_NAME,
    buildDocDefinition
  });
};
