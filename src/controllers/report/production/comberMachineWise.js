// Comber Machine Wise (Upto-Date Detail) report.
// Mirrors rptComberMachineWiseDetails_report.rdlc — per-machine view of upto-date
...
const TITLE = 'COMBER MACHINE WISE UPDATE PRODUCTION';
const FILE_NAME = 'ComberProduction_MachineWise';
...
function buildDocDefinition({ rows, companyName, companyLogo, fromDate, toDate }) {
  ...
  const summary = buildGroupSummaryPage({
    ...
    title: 'COMBER MACHINE WISE - SUMMARY',
...
export const comberMachineWiseReport = (req, res) => {
