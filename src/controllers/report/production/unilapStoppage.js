// UniLap Stoppage Wise report.
// Mirrors rptUnlilapProdn_Stoppage.rdlc — one row per stoppage reason, with
// HRS and % columns for each shift, plus on-date and upto-date totals.
//
// SP: sp_Prodn_Unilap_Stoppage (CompanyCode, FromDate, ToDate)
...
const TITLE = 'UNILAP STOPPAGE REPORT';
const FILE_NAME = 'UnilapProduction_StoppageWise';
...
export const unilapStoppageReport = (req, res) => {
  return runReport(req, res, {
    spName: 'sp_Prodn_Unilap_Stoppage',
    fileName: FILE_NAME,
    buildDocDefinition
  });
};
