// Finisher Drawing Production Summary (Date Wise) report.
// Mirrors 02rptFinisherDrawingProductionDayWise.rdlc — one row per machine, shows
...
const TITLE = 'FINISHER DRAWING PRODUCTION DAY REPORT - MACHINE WISE';
const FILE_NAME = 'FinisherDrawingProduction_Summary';
...
function buildDocDefinition({ rows, companyName, companyLogo, fromDate, toDate }) {
  ...
  const summary = buildGroupSummaryPage({
    ...
    title: 'FINISHER DRAWING PRODUCTION DAY REPORT - SUMMARY',
...
export const finisherDrawingProductionSummaryReport = (req, res) => {
