// Breaker Drawing Production Summary (Date Wise) report.
// Mirrors rptDrawingProductionSheetDateWise.rdlc — one row per machine, shows
...
const TITLE = 'BREAKER DRAWING PRODUCTION DAY REPORT - MACHINE WISE';
const FILE_NAME = 'DrawingProduction_Summary';
...
function buildDocDefinition({ rows, companyName, companyLogo, fromDate, toDate }) {
  ...
  const summary = buildGroupSummaryPage({
    ...
    title: 'BREAKER DRAWING PRODUCTION DAY REPORT - SUMMARY',
...
export const drawingProductionSummaryReport = (req, res) => {
