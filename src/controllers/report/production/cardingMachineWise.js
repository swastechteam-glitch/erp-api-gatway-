// Carding Machine Wise (Upto-Date Detail) report.
// Mirrors rptCardingMachineWiseDetails_report.rdlc — per-machine view of upto-date
...
const TITLE = 'CARDING MACHINE WISE UPDATE PRODUCTION';
const FILE_NAME = 'CardingProduction_MachineWise';
...
function buildDocDefinition({ rows, companyName, companyLogo, fromDate, toDate }) {
  ...
  const summary = buildGroupSummaryPage({
    ...
    title: 'CARDING MACHINE WISE - SUMMARY',
...
export const cardingMachineWiseReport = (req, res) => {
