// Simplex Machine Wise (Upto-Date Detail) report.
// Mirrors 03rptSimplexMachineWise.rdlc — per-machine view of upto-date
...
const TITLE = 'SIMPLEX MACHINE WISE UPDATE PRODUCTION';
const FILE_NAME = 'SimplexProduction_MachineWise';
...
function buildDocDefinition({ rows, companyName, companyLogo, fromDate, toDate }) {
  ...
  const summary = buildGroupSummaryPage({
    ...
    title: 'SIMPLEX MACHINE WISE - SUMMARY',
...
export const simplexMachineWiseReport = (req, res) => {
