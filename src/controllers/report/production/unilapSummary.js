// UniLap Production Summary (Date Wise) report.
// Mirrors rptUnilapProductionSheetDateWise.rdlc — one row per machine, shows
...
const TITLE = 'UNILAP PRODUCTION DAY REPORT - MACHINE WISE';
const FILE_NAME = 'UnilapProduction_Summary';
...
function buildDocDefinition({ rows, companyName, companyLogo, fromDate, toDate }) {
  ...
  const summary = buildGroupSummaryPage({
    ...
    title: 'UNILAP PRODUCTION DAY REPORT - SUMMARY',
...
export const unilapProductionSummaryReport = (req, res) => {
