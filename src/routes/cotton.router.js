...
router.get('/overview/allowance-generation-overview/list',authenticate, cotton);
router.get('/overview/bill-passing-overview/list',authenticate, cotton);
router.get('/overview/issue-lot-overview/list',authenticate, cotton);
router.get('/overview/purchase-order-overview/list',authenticate, cotton);
router.get('/overview/quality-test-overview/list',authenticate, cotton);
router.get('/overview/reject-lot-overview/list',authenticate, cotton);
