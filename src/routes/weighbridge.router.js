...
router.all('/reports/weighment/date-wise', weighbridge);
router.all('/reports/weighment/item-wise', weighbridge);
router.all('/reports/weighment/vehicle-wise', weighbridge);
