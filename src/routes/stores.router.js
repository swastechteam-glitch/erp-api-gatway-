...
router.all('/overview/bill-passing-overview/list',authenticate, stores);
router.all('/overview/goods-in-approval-overview/list',authenticate, stores);
router.all('/overview/goods-out-approval1-overview/list',authenticate, stores);
router.all('/overview/goods-out-approval2-overview/list',authenticate, stores);
router.all('/overview/purchase-advice-approve-overview/list',authenticate, stores);
router.all('/overview/purchase-order-approve1-overview/list',authenticate, stores);
router.all('/overview/purchase-order-approve2-overview/list',authenticate, stores);
router.all('/overview/purchase-order-approve3-overview/list',authenticate, stores);
