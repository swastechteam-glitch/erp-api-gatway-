...
router.get('/options-direct', authenticate, purchaseOrder);
router.get('/item-last-purchase/:itemCode', authenticate, purchaseOrder);
...
router.get('/item-supplier-history/:itemCode', authenticate, purchaseOrder);
