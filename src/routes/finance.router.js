...
router.all('/overview/adv-payment-approve1-overview/list/:id?',authenticate, finance);
router.all('/overview/adv-payment-approve2-overview/list/:id?',authenticate, finance);
router.all('/overview/credit-note-details-overview/list/:id?',authenticate, finance);
router.all('/overview/credit-note/approve',authenticate, finance);
router.all('/overview/debit-note-details-overview/list/:id?',authenticate, finance);
...
router.all('/overview/payment-approve-overview/list/:id?',authenticate, finance);
router.all('/overview/payment/approve',authenticate, finance);
router.all('/overview/receipt-approvals-overview/list/:id?',authenticate, finance);
