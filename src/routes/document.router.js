...
router.get('/reports/cotton/quality-slip-print',authenticate, document);
router.get('/reports/cotton/quality-slip-print/details',authenticate, document);
router.get('/reports/cotton/sales-print',authenticate, document);
router.get('/reports/cotton/sales-print/details',authenticate, document);
